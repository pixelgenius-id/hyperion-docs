...
##### Example
```
curl -X POST "https://vexascan.com/v1/history/get_actions"
```
...
##### Example
```
curl -X POST "https://vexascan.com/v1/history/get_controlled_accounts" -d '{"controlling_account":"vexcore"}'
```
...
##### Example
```
curl -X POST "https://vexascan.com/v1/history/get_key_accounts" -d '{"public_key":"VEX8fDDZm7ommT5XBf9MPYkRioXX6GeCUeSNkTpimdwKon5bNAVm7"}'
```
...
##### Example
```
curl -X POST "https://vexascan.com/v1/history/get_transaction"
```
...
##### Example
```
curl -X POST "https://vexascan.com/v1/chain/get_block" -d '{"block_num_or_id": "1000"}'
```
...
Get block 10000:
```
curl -X POST --url https://vexascan.com/v1/trace_api/get_block --data '{"block_num": 10000}' --header 'content-type: application/json'
```

Get latest block:
```
curl -X POST --url https://vexascan.com/v1/trace_api/get_block --data '{"block_num": -1}' --header 'content-type: application/json'
```

By block_id:
```
curl -X POST --url https://vexascan.com/v1/trace_api/get_block --data '{"block_id": "0307e42d3b2328805606929438411aa78dffb1756b2a0bcb2a9f7ce8a7035990"}' --header 'content-type: application/json'
```
